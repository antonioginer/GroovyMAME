...
sound_module::abuffer::abuffer(uint32_t channels, uint32_t rate) noexcept : m_channels(channels), m_used_buffers(0), m_unused_buffers(0), m_last_sample(channels, 0)
{
	(void) rate;
