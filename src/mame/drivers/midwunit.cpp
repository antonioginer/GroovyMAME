...
/*************************************************************************
    ...
    Games supported:
        ...
        * Ultimate Mortal Kombat 3
				* Ultimate Mortal Kombat 3 + (Beta 1)
        * NBA Hangtime
...
GAME( 2019, umk3p,     umk3,  	 wunit_picemu, mk3, 	 midwunit_state, init_umk3,	ROT0, "hack", "Ultimate Mortal Kombat 3 + (Beta 1)", MACHINE_SUPPORTS_SAVE )
